...
// Lit l'en-t̻te d'un fichier elf pass̩ en descripteur
// retourne la structure d'en-t̻te remplie.

Elf_identificator Lecture_identificateur (FILE* f){
  Elf_identificator header;
  int i;
  printf("\n\nELF Header:\n");
  // R̩cup̬re l'identificateur dans la structure
  ...
  // Verifie l'OS utilis̩ (on ne connait pas les autres codes, mais 0 signifie linux sans
